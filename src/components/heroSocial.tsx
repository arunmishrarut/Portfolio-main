...
const HeroSocial = () => {
  return (
    <div className='mt-5 flex flex-row gap-3'>
      <motion.a
        href='https://www.linkedin.com/in/arunmishra-iitism/'
        target='_blank'
        rel='noreferrer'
      ...
      <motion.a
        href='https://github.com/arunmishrarut'
        target='_blank'
        rel='noreferrer'
        className='h-9 w-9 cursor-pointer text-text hover:text-primary focus:text-primary'
      ...
      <motion.a
        href="mailto:arunmishra.iitism@gmail.com?subject=Reaching%20Out%20to%20you%20from%20your%20Portfolio&body=Your%20message%20here"
