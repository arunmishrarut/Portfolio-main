...
const ExperienceCard = ({ experience, currentColors }: { experience: any; currentColors: any }) => (
  <VerticalTimelineElement
    ...
    icon={
      <a href={experience.link} target="_blank" rel="noopener noreferrer" className="pointer-events-auto text-[24px] font-bold text-text" style={{ display: 'block' }}>
      <Image src={experience.icon} alt={experience.companyName} className='rounded-full object-contain shadow-timeline-border' />
      </a> 
    }
  >
    <div>
      <a href={experience.link} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
