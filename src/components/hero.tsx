    ...
    <section className='relative z-10 mx-auto h-screen-large w-full select-none'>
      ...
      <div className='paddingX absolute inset-0 top-[80px] mx-auto flex max-w-7xl flex-row items-start gap-5 xs:top-[120px] '>
        ...
        <div className='pointer-events-auto'>
          <h1 className='mt-2 flex flex-wrap text-[40px] font-black text-text sm:text-[60px] lg:text-[80px] lg:leading-[98x] xs:text-[50px]'>
            <div>
              <motion.span
                ref={handleSpanRef}
          ...
          <motion.p
            className='about-text leading-[20px] mt-0 text-[16px] font-medium text-text sm:text-[26px] lg:text-[30px] lg:leading-[40px] xs:mt-0 xs:text-[20px] xs:leading-normal'
